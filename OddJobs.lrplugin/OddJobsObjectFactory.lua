...
local OddJobsObjectFactory, dbg, dbgf = ObjectFactory:newClass{ className = 'OddJobsObjectFactory', register = false }
...
--
function OddJobsObjectFactory:newClass( t )
...
--
function OddJobsObjectFactory:new( t )
...
--
function OddJobsObjectFactory:frameworkModule( spec )
...
--
function OddJobsObjectFactory:newObject( class, ... )
    if type( class ) == 'table' then
        --if class == Manager then
        --    return OddJobsManager:new( ... )
        --end
